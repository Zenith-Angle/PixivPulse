...
当前版本：**v0.5.12**。需要 **Chrome 120+**，通过已解压扩展安装。

### 首次安装

1. 在 [最新 Release](https://github.com/Zenith-Angle/PixivPulse/releases/latest) 下载 `pixiv-pulse-v0.5.12-chrome.zip`。请选择这个安装包，GitHub 自动生成的 **Source code** 是源码包。
...
```powershell
Get-FileHash .\pixiv-pulse-v0.5.12-chrome.zip -Algorithm SHA256
```
