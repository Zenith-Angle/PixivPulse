...
> 文档版本：1.0.1 · 编写日期：2026-09-08
>
> 讲解基线：PixivPulse **0.5.10**，代码提交 **`7d5c965`**。
>
> **版本差异（2026-09-12）：** 本教程保留 0.5.10 的历史讲解。0.5.14 已删除输入／输出预算、历史裁剪与输出参数设置，改为无损证据编码、可回查笔记和默认新对话；0.5.15 继续调整按问题取数、时段聚合和服务式反馈，见 [工作流改造说明](./agent-workflow-0.5.15.md)。当前行为见 [Agent 使用指南](./agent-guide.zh-CN.md) 与 [本次改造说明](./agent-context-0.5.14.md)。下文预算公式及旧界面不代表当前实现。
>
